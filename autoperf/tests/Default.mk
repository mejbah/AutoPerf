...
MYLIB_DIR = ../$(HOME)/autoperf/profiler
MYLIB = perfpoint
CC = gcc 
CXX = g++ 
...
RPATH = -Wl,-rpath $(MYLIB_DIR) -Wl,-rpath

#PAPI_LIB = /home/mejbah/WorkInProgress/perfpoint/papi/lib
LD_FLAGS = -L$(MYLIB_DIR) $(APP_LIB_DIR)
